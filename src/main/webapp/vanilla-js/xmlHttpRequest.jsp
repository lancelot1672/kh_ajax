...
<script>
    ...
    document.searchFrm.addEventListener('submit', (e) =>{
        ...
        // 2. xhr 객체 연결 상태 변화에 따른 핸들러함수 바인딩
    ...
    const readyStateChangeHandler = (e) =>{
        switch (xhr.readyState){
            case 0 :
                console.log('0 : uninitialized'); break;    //xhr 객체 생성
            case 1 :
                console.log('1 : loading'); break;  //open 연결중
...
<script>
    document.signupFrm.addEventListener('submit',(e)=>{
        ...
        xhr.open("POST", "<%= request.getContextPath()%>/vanilla-js/search");
